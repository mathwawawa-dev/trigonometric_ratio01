...
OUT_DIR = os.path.join(ROOT, 'triangles4', 'dash_test3')
...
trim_module_path = os.path.join(PY_DIR, '_dash_trim_module3.py')
with open(trim_module_path, 'w', encoding='utf-8') as f:
    f.write(patched_code)

spec = importlib.util.spec_from_file_location('tri_dash_trim3', trim_module_path)
...
for tid, tmpl, var in samples:
    ...
    fname = f"tri_{tid}_{tmpl}{var}_trim3.png"
