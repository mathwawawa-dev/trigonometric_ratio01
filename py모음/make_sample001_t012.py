# -*- coding: utf-8 -*-
"""
make_sample001_t012.py — T012 4개 이미지 가장 짧은 변 0.12 만큼 확대하여 sample001/에 생성
"""
...
# T012 data: leg1=7, leg2=24, hyp=25
p = 7
q = 24
p_lbl = '$7$'
q_lbl = '$24$'
...
targets = [
    (1, 'A', 'tri_T012_1a_A.png'),
    (1, 'C', 'tri_T012_1a_C.png'),
    (2, 'A', 'tri_T012_2a_A.png'),
    (2, 'B', 'tri_T012_2a_B.png'),
]
...
print("Generated 4 sample T012 images in sample001/")
