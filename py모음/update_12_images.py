# -*- coding: utf-8 -*-
"""
update_12_images.py — Tri_img_01, Tri_img_02, Tri_img_03 내 T024 1a/2a 12개 이미지 0.33 sagitta_frac 적용 재생성
"""
...
# T024 4개 항목
# 1) tmpl=1, target='A', fname_suffix='1a_A.png'
# 2) tmpl=1, target='C', fname_suffix='1a_C.png'
# 3) tmpl=2, target='A', fname_suffix='2a_A.png'
# 4) tmpl=2, target='B', fname_suffix='2a_B.png'
...
print("All 12 images updated successfully!")
