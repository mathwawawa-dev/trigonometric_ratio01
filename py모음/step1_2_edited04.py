...
= 최대 180개 PNG → triangles4/type1_edited04/
...
TYPE1_DIR = os.path.join(ROOT, 'triangles4', 'type1_edited04')
...
mod.OUTPUT_DIR = TYPE1_DIR     # 출력 폴더를 type1_edited04/ 으로 override
draw = mod.draw
...
print(f"\n{'='*55}")
print(f"✅ 완료: {count}개 이미지 → triangles4/type1_edited04/")
